###########################################################################
## Makefile generated for component 'Draw_Graph_Flex_Vol_SIMULINK'. 
## 
## Makefile     : Draw_Graph_Flex_Vol_SIMULINK.mk
## Generated on : Thu Mar 28 19:35:55 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Draw_Graph_Flex_Vol_SIMULINK.elf
...
PRODUCT_NAME              = Draw_Graph_Flex_Vol_SIMULINK
MAKEFILE                  = Draw_Graph_Flex_Vol_SIMULINK.mk
MATLAB_ROOT               = D:/MATLAB
MATLAB_BIN                = D:/MATLAB/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/THINGS/Matlab/Matlab_Practice/Relative_arduino/Flex_Vol_Graph
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Draw_Graph_Flex_Vol_SIMULINK.elf
...
DEFINES_STANDARD = -DMODEL=Draw_Graph_Flex_Vol_SIMULINK -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o xcp_ext_mode.o Draw_Graph_Flex_Vol_SIMULINK.o Draw_Graph_Flex_Vol_SIMULINK_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Draw_Graph_Flex_Vol_SIMULINK_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Draw_Graph_Flex_Vol_SIMULINK_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Draw_Graph_Flex_Vol_SIMULINK_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Draw_Graph_Flex_Vol_SIMULINK.o : $(START_DIR)/Draw_Graph_Flex_Vol_SIMULINK_ert_rtw/Draw_Graph_Flex_Vol_SIMULINK.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Draw_Graph_Flex_Vol_SIMULINK_data.o : $(START_DIR)/Draw_Graph_Flex_Vol_SIMULINK_ert_rtw/Draw_Graph_Flex_Vol_SIMULINK_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Draw_Graph_Flex_Vol_SIMULINK_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
