...
void Draw_Graph_Flex_Vol_SIMULINK_step(void)
{
  ...
  /* MATLABSystem: '<Root>/Lowpass Filter1' incorporates:
  ...
  /* System object Outputs function: dsp.FIRFilter */
  Draw_Graph_Flex_Vol_SIMULINK_B.Angle_l = ((4.98 /
...
void Draw_Graph_Flex_Vol_SIMULINK_initialize(void)
{
  ...
  /* External mode info */
  Draw_Graph_Flex_Vol_SIMULINK_M->Sizes.checksums[0] = (2625255387U);
  Draw_Graph_Flex_Vol_SIMULINK_M->Sizes.checksums[1] = (312024901U);
  Draw_Graph_Flex_Vol_SIMULINK_M->Sizes.checksums[2] = (447817312U);
  Draw_Graph_Flex_Vol_SIMULINK_M->Sizes.checksums[3] = (2478903407U);
