###########################################################################
## Makefile generated for component 'Z_Flex_Simulink'. 
## 
## Makefile     : Z_Flex_Simulink.mk
## Generated on : Mon Mar 18 15:14:54 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Z_Flex_Simulink.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Z_Flex_Simulink.elf
...
DEFINES_STANDARD = -DMODEL=Z_Flex_Simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o xcp_ext_mode.o Z_Flex_Simulink.o Z_Flex_Simulink_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Z_Flex_Simulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Z_Flex_Simulink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Z_Flex_Simulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Z_Flex_Simulink.o : $(START_DIR)/Z_Flex_Simulink_ert_rtw/Z_Flex_Simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Z_Flex_Simulink_data.o : $(START_DIR)/Z_Flex_Simulink_ert_rtw/Z_Flex_Simulink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Z_Flex_Simulink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
